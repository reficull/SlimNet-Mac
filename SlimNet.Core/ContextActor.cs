...
namespace SlimNet
{
    public partial class Context
    {
        ...
        internal void InstantiateActor(Network.IConnection connection, int prefabId, ushort actorId, ushort playerId, SlimMath.Vector3 position)
        {
            Actor actor;
            InstantiateActor(connection, prefabId, actorId, playerId, position, out actor);
        }

        internal bool InstantiateActor(Network.IConnection connection, int prefabId, ushort actorId, ushort playerId, SlimMath.Vector3 position, out Actor instance)
        {
